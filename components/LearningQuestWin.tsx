    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-indigo-900/90 backdrop-blur-md">
            <motion.div
                ...
                className="bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden relative z-10 text-center p-8 border-4 border-yellow-400"
            >
                ...
                <h2 className="text-3xl font-extrabold text-indigo-800 mb-2 uppercase tracking-wide">
                    CONGRATULATIONS!
                </h2>
                ...
                <div className="mb-8">
                    <div className="inline-block bg-yellow-100 text-yellow-800 px-4 py-2 rounded-full font-bold text-sm border border-yellow-200 shadow-sm">
                ...
                <div className="space-y-3">
                    <button
                        ...
                        className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-xl shadow-lg transition-transform hover:scale-[1.02] active:scale-95 uppercase tracking-wide"
                    >
                        LEADERBOARD
                    </button>
                    <button
                        onClick={onPlayAgain}
                        className="w-full bg-white hover:bg-slate-50 text-slate-700 font-bold py-3 rounded-xl border-2 border-slate-200 transition-all uppercase"
                    >
                        PLAY AGAIN
                    </button>
                </div>
