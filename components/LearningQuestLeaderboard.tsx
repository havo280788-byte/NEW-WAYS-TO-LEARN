...
export const LearningQuestLeaderboard: React.FC<LearningQuestLeaderboardProps> = ({ onClose }) => {
    ...
    useEffect(() => {
        ...
        if (saved) {
            ...
            setEntries(sorted.slice(0, 50)); // Top 50 only for display
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-indigo-900/40 backdrop-blur-md">
            ...
            >
                <div className="p-6 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 text-white text-center relative shrink-0">
                    <button
                        onClick={onClose}
                    ...
                    <p className="text-white/90 text-sm font-bold">TOP 50 FASTEST COMPLETION TIMES</p>
